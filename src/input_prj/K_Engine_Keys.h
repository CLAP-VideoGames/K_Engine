...
#ifndef K_ENGINE_KEYS
#define K_ENGINE_KEYS
...
#define SCANCODE_TO_KEYCODE(X)  (X | KEY_SCANCODE_MASK)
    ...
    typedef enum
    {
         ...
         */
         ...
         KEY_EXEC = SCANCODE_TO_KEYCODE(SCANCODE_EXECUTE),
