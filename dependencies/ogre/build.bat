...
%CMAKE_EXEC% -D CMAKE_CONFIGURATION_TYPES:STRING=Debug;Release ^
             ...
             -D OGRE_BUILD_COMPONENT_TERRAIN:BOOL=0 ^
             -D OGRE_BUILD_COMPONENT_VOLUME:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_ASSIMP:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_BSP:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_DOT_SCENE:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_GLSLANG:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_OCTREE:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_PCZ:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_PFX:BOOL=0 ^
             -D OGRE_BUILD_PLUGIN_STBI:BOOL=1 ^
             -D OGRE_BUILD_RENDERSYSTEM_D3D11:BOOL=0 ^
             -D OGRE_BUILD_RENDERSYSTEM_D3D9:BOOL=0 ^
             -D OGRE_BUILD_RENDERSYSTEM_GL:BOOL=1 ^
             -D OGRE_BUILD_RENDERSYSTEM_GL3PLUS:BOOL=1 ^
             ...
             -D OGRE_BUILD_TESTS:BOOL=0 ^
             -D OGRE_BUILD_TOOLS:BOOL=0 ^
